...
function () {
  ...
  function GS1DigitalLinkToolkit() {
    ...
    var tableOpt = {
      ...
      "CB": ["255", "3941"],
      "CC": ["255", "3942"],
      "CD": ["255", "3943"] // safeBase64Alphabet is a modified URI-safe Base64 alphabet used in the compression methods for converting the binary string to/from an alphanumeric representation that contains no characters that are restricted in URIs
