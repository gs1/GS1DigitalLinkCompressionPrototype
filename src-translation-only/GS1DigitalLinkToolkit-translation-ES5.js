...
function () {
  ...
  _createClass(GS1DigitalLinkToolkit, [{
    ...
    value: function extractFromGS1digitalLink(gs1DigitalLinkURI) {
      ...
      for (var _k2 in candidates) {
        if (candidates.hasOwnProperty(_k2)) {
          this.verifySyntax(_k2, candidates[_k2]);
          this.verifyCheckDigit(_k2, candidates[_k2]);
          obj[_k2] = padGTIN(_k2, candidates[_k2]);
        }
      }
    ...
    value: function buildGS1elementStrings(gs1AIarray, brackets) {
      ...
      if (brackets == true) {
        ...
        for (var _i5 in fixedLengthPrimaryIdentifier) {
          elementStrings = elementStringsPush(elementStrings, fixedLengthPrimaryIdentifier[_i5], gs1AIarray[fixedLengthPrimaryIdentifier[_i5]], "");
        }

        for (var _i6 in fixedLengthValuesOther) {
          elementStrings = elementStringsPush(elementStrings, fixedLengthValuesOther[_i6], gs1AIarray[fixedLengthValuesOther[_i6]], "");
        }

        for (var _i7 in variableLengthValues) {
          var gs = "";

          if (_i7 < variableLengthValues.length - 1) {
            gs = this.groupSeparator;
          }

          elementStrings = elementStringsPush(elementStrings, variableLengthValues[_i7], gs1AIarray[variableLengthValues[_i7]], gs);
        }
      }
